...
const atmosphereShader = {
  'atmosphere': {
    ...
    fragmentShader: [
      'varying vec3 vNormal;',
      'void main() {',
      'float intensity = pow( 1.05 - dot( vNormal, vec3( 0, 0, 1.0 ) ), 6.0 );',
...
// addEventListener('onWindowResize', (e) => {
