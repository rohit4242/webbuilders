                            ...
                            <div className="mb-12 max-w-[570px] lg:mb-0">
                                ...
                                <div className="mb-8 flex w-full max-w-[370px] text-gray-800 dark:text-gray-200">
                                    ...
                                    <div className="w-full">
                                        ...
                                        <p className="text-body-color text-base">me@rencho.com</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="relative rounded-lg bg-white dark:bg-slate-900 text-gray-800 p-8 shadow-lg sm:p-12">
                                <form onSubmit={sendEmail}>
                                    ...
                                    <div className="mb-6">
                                        ...
                                        ></textarea>
                                        <p className="text-teal-500 text-xs italic">{MessageText}</p>
                                    </div>
                                    <div>
                                        <button
                                            type="submit"
                                            className="bg-teal-500 hover:bg-teal-400 border-primary w-full rounded border p-3 text-white transition hover:bg-opacity-90"
                                        >
                                            Send Message
                                        </button>
                                    </div>
