...
const Contact = () => {
    return (
        <>
            <section class="relative z-10 overflow-hidden py-4 lg:py-[120px] mb-32 font-Poppins">
                <div class="container mx-auto">
                    <div class="-mx-4 flex flex-wrap lg:justify-between">
                        <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
                            <div class="mb-12 max-w-[570px] lg:mb-0">
                                <span class="text-teal-500 text-center text-4xl mb-4 block text-base font-Poppins">
                                    Contact Us
                                </span>
                                <h2
                                    class="text-dark mb-6 text-[32px] font-bold uppercase font-Poppins sm:text-[40px] lg:text-[36px] xl:text-[40px]"
                                >
                                ...
                                <div class="mb-8 flex w-full max-w-[370px]">
                                    ...
                                    <div class="w-full">
                                        ...
                                        <p class="text-body-color text-base">(+91)70695 88487</p>
                                    </div>
                                </div>
                                <div class="mb-8 flex w-full max-w-[370px]">
                                    <div
                                    ...
                                    <div class="w-full">
                                        ...
                                        <p class="text-body-color text-base">me@rencho.com</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
                            <div class="relative rounded-lg bg-white text-gray-800 p-8 shadow-lg sm:p-12">
                                <form>
                                    <div class="mb-6">
                                        <input
                                            type="text"
                                            placeholder="Your Name"
                                            class=" border-[f0f0f0] focus:border-primary w-full rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none"
                                        />
                                    </div>
                                    <div class="mb-6">
                                        <input
                                    ...
                                    <div class="mb-6">
                                        <textarea
                                            ...
                                            class=" border-[f0f0f0] focus:border-primary w-full resize-none rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none"
                                        ></textarea>
                                    </div>
                                    <div>
                                        <button
                                            type="submit"
                                            class="bg-teal-500 hover:bg-teal-400 border-primary w-full rounded border p-3 text-white transition hover:bg-opacity-90"
                                        >
                                            Send Message
                                        </button>
                                    </div>
