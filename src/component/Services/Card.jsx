...
const Card = (props) => {
  return (
    <>
       <div class="p-4 lg:w-1/2 md:w-full hover:scale-105 ">
        <div class="flex border-2 rounded-lg border-gray-200  border-opacity-50 p-8 sm:flex-row flex-col hover:shadow-[4.0px_8.0px_8.0px_rgba(0,150,136,0.90)] gradient-border">
